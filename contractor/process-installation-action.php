    ...
    switch ($action) {
        ...
        case 'update_timings':
            ...
            if (!$arrivalDateTime || !$installationDateTime) {
                ...
                error_log("Invalid datetime format - Arrival: $arrivalTime, Installation: $installationStartTime");
                throw new Exception('Invalid datetime format. Expected format: YYYY-MM-DDTHH:MM');
            }
            ...
            if ($result) {
                ...
                error_log("Timings updated successfully for installation $installationId");
                echo json_encode(['success' => true, 'message' => 'Timings updated successfully']);
            } else {
                error_log("Failed to update timings for installation $installationId");
