            ...
            <div class="form-section" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); border: none; color: white;">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div class="form-group">
                        ...
                        <input type="datetime-local" name="checkin_datetime" id="checkin_datetime" class="form-input" readonly required style="background: rgba(255,255,255,0.95); color: black;">
                    </div>
                    <div class="form-group">
