...
<div class="flex justify-between items-center mb-6">
    ...
    <div class="flex space-x-2">
        <a href="<?php echo BASE_URL; ?>/contractor/sites/" class="btn btn-secondary">
...
function updateProgress(delegationId) {
    window.location.href = `<?php echo BASE_URL; ?>/contractor/update-progress.php?id=${delegationId}`;
}
</script>
