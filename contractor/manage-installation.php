...
<div class="flex justify-between items-center mb-6">
    ...
    <div class="flex space-x-3">
        ...
        <a href="../shared/view-survey.php?id=<?php echo $installation['survey_id']; ?>" class="inline-flex items-center px-4 py-2 border border-green-300 text-sm font-medium rounded-md text-green-700 bg-green-50 hover:bg-green-100 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500">
        ...
        <?php endif; ?>
        <a href="installation-material-usage.php?id=<?php echo $installationId; ?>" class="inline-flex items-center px-4 py-2 border border-blue-300 text-sm font-medium rounded-md text-blue-700 bg-blue-50 hover:bg-blue-100 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
            <svg class="w-4 h-4 mr-2" fill="currentColor" viewBox="0 0 20 20">
                ...
                <div class="space-y-4">
                    ...
                    <div class="space-y-2">
                        ...
                        <?php if ($installation['status'] === 'in_progress'): ?>
                            <a href="installation-daily-work.php?id=<?php echo $installationId; ?>" 
