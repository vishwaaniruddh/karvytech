...
<script>
    ...
    function renderStats(stats) {
        try {
            ...
            {
                label: 'Delegated',
                count: stats.delegation_active || 0,
                color: 'blue',
            ...
            {
                label: 'Inst. Done',
                count: stats.installation_done || 0,
                color: 'purple',
