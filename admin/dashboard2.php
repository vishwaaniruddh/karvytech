    ...
    <?php if (Auth::hasModuleAccess('users')): ?>
        <div
            ...
            <div class="p-5">
                ...
                <div class="flex items-center justify-between">
                    <div
                        class="w-12 h-12 bg-gradient-to-br from-green-500 to-green-600 rounded-xl flex items-center justify-center shadow-lg flex-shrink-0">
                        <svg class="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <div class="text-right">
                        <div class="text-2xl font-bold text-gray-900">
                            <?php echo number_format($vendorStats['active'] ?? 0); ?></div>
                        <div class="text-sm text-gray-600 mt-1">
    ...
    <?php if (Auth::hasModuleAccess('surveys')): ?>
        <div
            ...
            <div class="p-5">
                ...
                <div class="flex items-center justify-between">
                    <div
                        class="w-12 h-12 bg-gradient-to-br from-yellow-500 to-yellow-600 rounded-xl flex items-center justify-center shadow-lg flex-shrink-0">
                        <svg class="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <div class="text-right">
                        <div class="text-2xl font-bold text-gray-900">
                            <?php echo number_format($surveyStats['pending'] ?? 0); ?></div>
                        <div class="text-sm text-gray-600 mt-1">
    ...
    <?php if (Auth::hasModuleAccess('installations')): ?>
        <div
            ...
            <div class="p-5">
                ...
                <div class="flex items-center justify-between">
                    <div
                        class="w-12 h-12 bg-gradient-to-br from-purple-500 to-purple-600 rounded-xl flex items-center justify-center shadow-lg flex-shrink-0">
                        <svg class="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <div class="text-right">
                        <div class="text-2xl font-bold text-gray-900">
                            <?php echo number_format($installationStats['in_progress'] ?? 0); ?></div>
                        <div class="text-sm text-gray-600 mt-1">
...
<div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
    ...
    <div class="bg-white shadow-lg rounded-xl border border-gray-100 p-6">
        ...
        <div class="space-y-3">
            <div class="flex justify-between items-center">
                ...
                <span
                    class="font-semibold text-gray-900"><?php echo number_format($inventoryStats['total_items'] ?? 0); ?></span>
            </div>
            <div class="flex justify-between items-center">
                <span class="text-sm text-gray-600">Total Quantity</span>
                <span
                    class="font-semibold text-gray-900"><?php echo number_format($inventoryStats['total_quantity'] ?? 0); ?></span>
            </div>
            <div class="flex justify-between items-center">
                <span class="text-sm text-gray-600">Low Stock Items</span>
                <span
                    class="font-semibold text-red-600"><?php echo number_format($inventoryStats['low_stock_items'] ?? 0); ?></span>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white shadow-lg rounded-xl border border-gray-100 p-6">
        ...
        <div class="space-y-3">
            <div class="flex justify-between items-center">
                ...
                <span
                    class="font-semibold text-gray-900"><?php echo number_format($requestStats['total'] ?? 0); ?></span>
            </div>
            <div class="flex justify-between items-center">
                <span class="text-sm text-gray-600">Pending</span>
                <span
                    class="font-semibold text-yellow-600"><?php echo number_format($requestStats['pending'] ?? 0); ?></span>
            </div>
            <div class="flex justify-between items-center">
                <span class="text-sm text-gray-600">Dispatched</span>
                <span
                    class="font-semibold text-green-600"><?php echo number_format($requestStats['dispatched'] ?? 0); ?></span>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white shadow-lg rounded-xl border border-gray-100 p-6">
        ...
        <div class="space-y-4">
            <?php if (Auth::hasModuleAccess('sites')): ?>
                <a href="<?php echo BASE_URL; ?>/admin/sites/index.php"
                    class="block w-full bg-blue-50 hover:bg-blue-100 text-blue-700 px-4 py-2 rounded-lg text-sm font-medium transition-colors duration-200">
            ...
            <?php if (Auth::hasModuleAccess('users')): ?>
                <a href="<?php echo BASE_URL; ?>/admin/vendors/"
                    class="block w-full bg-green-50 hover:bg-green-100 text-green-700 px-4 py-2 rounded-lg text-sm font-medium transition-colors duration-200">
                    <svg class="w-4 h-4 inline mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <?php if (Auth::hasModuleAccess('inventory')): ?>
                <a href="<?php echo BASE_URL; ?>/admin/inventory/"
                    class="block w-full bg-purple-50 hover:bg-purple-100 text-purple-700 px-4 py-2 rounded-lg text-sm font-medium transition-colors duration-200">
                    <svg class="w-4 h-4 inline mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4"></path>
                    </svg>
            ...
            foreach ($statusData as $status):
                ...
                <div class="flex items-center justify-between">
                    ...
                    <div class="w-24 <?php echo $status['bg']; ?> rounded-full h-2">
                        <div class="<?php echo $status['color']; ?> h-2 rounded-full"
            ...
            foreach ($installationData as $installation):
                ...
                <div class="flex items-center justify-between">
                    ...
                    <div class="w-24 <?php echo $installation['bg']; ?> rounded-full h-2">
                        <div class="<?php echo $installation['color']; ?> h-2 rounded-full"
                            style="width: <?php echo $percentage; ?>%"></div>
                    </div>
                </div>
            <?php endforeach; ?>
...
<div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
    ...
    <div class="bg-white shadow-lg rounded-xl border border-gray-100 p-6">
        <div class="flex items-center justify-between mb-6">
            ...
            <a href="<?php echo BASE_URL; ?>/admin/vendors/" class="text-sm text-blue-600 hover:text-blue-800">View
                All</a>
        </div>
        <div class="space-y-4">
                ...
                <?php foreach ($topVendors as $index => $vendor): ?>
                    <div class="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                        <div class="flex items-center space-x-3">
                            ...
                            <div>
                                <p class="text-sm font-medium text-gray-900"><?php echo htmlspecialchars($vendor['name']); ?>
                                </p>
                                <p class="text-xs text-gray-500">
                                    <?php echo $vendor['surveys_completed']; ?> surveys,
                                    <?php echo $vendor['installations_completed']; ?> installations
                                </p>
                            </div>
                        </div>
                        <div class="text-right">
